...
def createParser():
    parser = argparse.ArgumentParser(
                    prog = 'reimaging',
                    description = '''Simple photo downloader/uploader
                                                                for vk.com''',
                    add_help = False)
